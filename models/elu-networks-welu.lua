...
local function createModel(opt)
   ...
   local function WELUInit()
      for k,v in pairs(model:findModules('nn.Mul')) do
         v.weight:rand(1)
      end
